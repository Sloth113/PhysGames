...
void Tutorial1App::shutdown() {

	delete m_font;
	delete m_2dRenderer;
}

void Tutorial1App::update(float deltaTime) {
...
void Tutorial1App::draw() {
	...
	char num[32];
	sprintf_s(num, 32, "FPS: %f", m_newVar);
	m_2dRenderer->drawText(m_font, num, 0, 720 - 32);
